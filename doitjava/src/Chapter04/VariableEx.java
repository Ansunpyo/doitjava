...
public class VariableEx {
	...
	public static void main(String[] args) {
		...
		int kimbap = 2000;	//김밥 2000원
		
		int order1 = 0, order2 = 0, order3 = 0, order4 = 0;		//변수 선언 후 초기값을 넣어주는게 좋다
		// 변수의 초기값은 숫자는 0, 불리언은 false, 문자열은 "", char형은 0으로 초기화
		order1 = 2;
		order2 = 1;
		order3 = 6;
		order4 = 1;
